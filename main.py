...
<h4>Total de dispositivos con llamada no completada: {total_incompleted_call_devices}</h4>
...
<table>
  ...
  {inactive_rows_string}
    ...
    # print("total dispositivos: "+ str(total_devices)+ " total dispositivos inactivos: "+ str(total_inactive_devices) + " total dispositivos con llamada no realizada: "+ str(total_incompleted_call_devices))      
